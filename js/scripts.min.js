!(function (e, t) {
	...
	var C = (function (e) {
		...
		try {
			N.apply((A = P.call(_.childNodes)), _.childNodes),
		...
		(ae.attr = function (e, t) {
			...
			var s = i.attrHandle[t.toLowerCase()],
				r =
					s && D.call(i.attrHandle, t.toLowerCase())
						? s(e, t, !g)
						: void 0;
			return void 0 !== r
				? r
			...
			return (
				...
				ce(function (r, o, a, l) {
					var c,
						...
						m = !e || (!r && t) ? g : be(g, p, e, a, l),
						v = n ? (s || (r ? e : f || i) ? [] : o) : m;
					if ((n && n(m, v, a, l), i))
						for (c = be(v, d), i(c, [], a, l), u = c.length; u--; )
							(h = c[u]) && (v[d[u]] = !(m[d[u]] = h));
					if (r) {
						if (s || e) {
							if (s) {
					...
					} else (v = be(v === o ? v.splice(f, v.length) : v)), s ? s(null, o, v, l) : N.apply(o, v);
				})
			);
		}
		function Te(e) {
			for (
				...
				if ((n = i.relative[e[l].type])) p = [xe(_e(p), n)];
				else {
					if (
						...
						(m = E(
							...
							(u = function (e, t, n, o, u) {
								...
								for (
									...
									a && ((h = !m && h) && v--, e && w.push(h));
								}
								if (((v += y), a && y !== v)) {
									for (f = 0; (m = r[f++]); ) m(w, x, t, n);
									if (e) {
										if (0 < v)
											for (; y--; )
												w[y] ||
	...
	_.fn.extend({
		...
		_.each(
			...
			function (e, t) {
				_.fn[e] = function (n, i) {
					var s = _.map(this, t, n);
					return (
						'Until' !== e.slice(-5) && (i = n),
						i && 'string' == typeof i && (s = _.filter(i, s)),
						1 < this.length &&
							(N[e] || _.uniqueSort(s), L.test(e) && s.reverse()),
						this.pushStack(s)
					);
				};
			}
	...
	(_.Callbacks = function (e) {
		...
		var i,
			...
			c = -1,
			u = function () {
				for (o = o || e.once, r = i = !0; l.length; c = -1)
		...
		_.extend({
					...
					s = {
						...
						then: function (t, i, s) {
							...
							return _.Deferred(function (e) {
								n[0][3].add(
									o(0, e, f(s) ? s : H, e.notifyWith)
								),
									n[1][3].add(o(0, e, f(t) ? t : H)),
									n[2][3].add(o(0, e, f(i) ? i : M));
							}).promise();
						},
						promise: function (e) {
			...
			when: function (e) {
				...
				if (
					t <= 1 &&
					(O(e, o.done(a(n)).resolve, o.reject, !t),
					'pending' === o.state() || f(r[n] && r[n].then))
				)
					return o.then();
	...
	var R = _.Deferred();
	function I() {
		m.removeEventListener('DOMContentLoaded', I),
	...
	(_.fn.ready = function (e) {
		...
		('loading' !== m.readyState && !m.documentElement.doScroll)
			...
			: (m.addEventListener('DOMContentLoaded', I),
	...
	var oe = function (e, t) {
		return (
			...
			('' === e.style.display && se(e) && 'none' === _.css(e, 'display'))
		);
	};
	function ae(e, t, n, i) {
		var s,
	...
	var le = {};
	function ce(e, t) {
		for (var n, i, s, r, o, a, l, c = [], u = 0, h = e.length; u < h; u++)
			(i = e[u]).style &&
				((n = i.style.display),
				t
					? ('none' === n &&
		...
		return (
			(n =
				void 0 !== e.getElementsByTagName
					...
					: []),
			void 0 === t || (t && k(e, t)) ? _.merge([e], n) : n
		);
	}
	function ve(e, t) {
		for (var n = 0, i = e.length; n < i; n++)
	...
	function we(e, t, n, i, s) {
		for (
			...
			if ((r = e[d]) || 0 === r)
				if ('object' === w(r)) _.merge(p, r.nodeType ? [r] : r);
				else if (ye.test(r)) {
					for (
						o = o || h.appendChild(t.createElement('div')),
							a = (de.exec(r) || ['', ''])[1].toLowerCase(),
							l = ge[a] || ge._default,
							o.innerHTML = l[1] + _.htmlPrefilter(r) + l[2],
							u = l[0];
						u--;

					)
						o = o.lastChild;
					_.merge(p, o.childNodes),
						((o = h.firstChild).textContent = '');
				} else p.push(t.createTextNode(r));
		for (h.textContent = '', d = 0; (r = p[d++]); )
			if (i && -1 < _.inArray(r, i)) s && s.push(r);
			else if (
				((c = se(r)),
				(o = me(h.appendChild(r), 'script')),
				c && ve(o),
				n)
			)
	...
	(_.event = {
					...
					(d = g = (a = be.exec(t[c]) || [])[1]),
						...
						d &&
							...
							(u = _.extend(
								{
									...
									selector: s,
									needsContext:
										s && _.expr.match.needsContext.test(s),
									namespace: f.join('.'),
								},
								r
							)),
							(p = l[d]) ||
								...
								(h.setup && !1 !== h.setup.call(e, i, f, o)) ||
									(e.addEventListener &&
		...
		dispatch: function (e) {
			...
			if (
				...
				for (
					o = _.event.handlers.call(this, l, c), t = 0;
	...
	function Pe(e, t) {
		...
		if (1 === t.nodeType) {
			if (Z.hasData(e) && (a = Z.get(e).events))
				for (s in (Z.remove(t, 'handle events'), a))
					for (n = 0, i = a[s].length; n < i; n++)
						_.event.add(t, s, a[s][n]);
			G.hasData(e) &&
				((r = G.access(e)), (o = _.extend({}, r)), G.set(t, o));
		}
	}
	function qe(e, t, n, i) {
		t = r(t);
		var s,
			...
			m = t[0],
			v = f(m);
		if (v || (1 < p && 'string' == typeof m && !d.checkClone && De.test(m)))
			return e.each(function (s) {
				var r = e.eq(s);
				v && (t[0] = m.call(this, s, r.html())), qe(r, t, n, i);
			});
		if (
			p &&
			...
			for (l = (a = _.map(me(s, 'script'), Le)).length; h < p; h++)
				(c = s),
					h !== g &&
						((c = _.clone(c, !0, !0)),
						l && _.merge(a, me(c, 'script'))),
					n.call(e[h], c, h);
			if (l)
				for (
					u = a[a.length - 1].ownerDocument, _.map(a, Ne), h = 0;
					h < l;
					h++
				)
					(c = a[h]),
	...
	function He(e, t, n) {
		for (var i, s = t ? _.filter(t, e) : e, r = 0; null != (i = s[r]); r++)
			n || 1 !== i.nodeType || _.cleanData(me(i)),
				i.parentNode &&
					(n && se(i) && ve(me(i, 'script')),
	...
	_.extend({
		...
		clone: function (e, t, n) {
			...
			if (
				...
				for (o = me(u), i = 0, s = (r = me(e)).length; i < s; i++)
					(a = r[i]),
			...
			if (t)
				if (n)
					for (
						r = r || me(e), o = o || me(u), i = 0, s = r.length;
						i < s;
						i++
					)
						Pe(r[i], o[i]);
		...
		cleanData: function (e) {
			for (
				var t, n, i, s = _.event.special, r = 0;
				void 0 !== (n = e[r]);
				r++
			)
				if (X(n)) {
		...
		_.each(
			...
			function (e, t) {
				_.fn[e] = function (e) {
					for (
						var n, i = [], s = _(e), r = s.length - 1, a = 0;
						a <= r;
						a++
					)
	...
	function Je(e, t, n, i, s, r) {
		...
		for (; o < 4; o += 2)
			'margin' === n && (l += _.css(e, n + ne[o], !0, s)),
				i
					? ('content' === n &&
							(l -= _.css(e, 'padding' + ne[o], !0, s)),
					  'margin' !== n &&
							(l -= _.css(e, 'border' + ne[o] + 'Width', !0, s)))
					: ((l += _.css(e, 'padding' + ne[o], !0, s)),
					  'padding' !== n
							? (l += _.css(e, 'border' + ne[o] + 'Width', !0, s))
							: (a += _.css(
	...
	function Ke(e, t, n) {
		...
		return (
			((!d.boxSizingReliable() && s) ||
				(!d.reliableTrDimensions() && k(e, 'tr')) ||
				'auto' === o ||
				(!parseFloat(o) && 'inline' === _.css(e, 'display', !1, i))) &&
	...
	_.extend({
		...
		_.each(['height', 'width'], function (e, t) {
			_.cssHooks[t] = {
				...
				set: function (e, n, i) {
					var s,
						r = Oe(e),
						o = !d.scrollboxSize() && 'absolute' === r.position,
						a =
							(o || i) &&
		...
		(_.cssHooks.marginLeft = Be(d.reliableMarginLeft, function (e, t) {
			if (t)
				return (
				...
				return B(
					...
					function (e, t, n) {
						var i,
							...
							o = 0;
						if (Array.isArray(t)) {
							for (i = Oe(e), s = t.length; o < s; o++)
								r[t[o]] = _.css(e, t[o], !1, i);
							return r;
						}
	...
	(_.Animation = _.extend(ht, {
		...
		_.each(['toggle', 'show', 'hide'], function (e, t) {
			var n = _.fn[t];
			_.fn[t] = function (e, i, s) {
				return null == e || 'boolean' == typeof e
					? n.apply(this, arguments)
					: this.animate(ct(t, !0), e, i, s);
			};
		}),
		_.each(
			{
					...
					return void 0 === e.getAttribute
						...
						: ((1 === r && _.isXMLDoc(e)) ||
								(s =
									...
									(_.expr.match.bool.test(t) ? pt : void 0)),
						  void 0 !== n
								? null === n
									? void _.removeAttr(e, t)
									: s &&
									  'set' in s &&
									  void 0 !== (i = s.set(e, n, t))
									? i
		...
		_.extend({
			prop: function (e, t, n) {
				...
				if (3 !== r && 8 !== r && 2 !== r)
					return (
						(1 === r && _.isXMLDoc(e)) ||
							((t = _.propFix[t] || t), (s = _.propHooks[t])),
						void 0 !== n
			...
			return arguments.length
				? ((i = f(e)),
				  this.each(function (n) {
						...
						1 === this.nodeType &&
							(null ==
							(s = i ? e.call(this, n, _(this).val()) : e)
								? (s = '')
								: 'number' == typeof s
								? (s += '')
								: Array.isArray(s) &&
				...
				? (t =
						_.valHooks[s.type] ||
						_.valHooks[s.nodeName.toLowerCase()]) &&
				  'get' in t &&
			...
			if (
				...
				for (r = 0; (o = v[r++]) && !t.isPropagationStopped(); )
					(d = o),
						...
						(h =
							(Z.get(o, 'events') || Object.create(null))[
								t.type
							] && Z.get(o, 'handle')) && h.apply(o, n),
						(h = c && o[c]) &&
							h.apply &&
							X(o) &&
					...
					s ||
						...
						(c &&
							...
							t.isPropagationStopped() &&
								d.addEventListener(y, _t),
							i[y](),
							t.isPropagationStopped() &&
								d.removeEventListener(y, _t),
	...
	function Dt(e, t, n, i) {
		...
		else for (s in t) Dt(e + '[' + s + ']', t[s], n, i);
	}
	...
	(zt.href = bt.href),
		_.extend({
			...
			ajax: function (t, n) {
				...
				d.ifModified &&
					...
					_.etag[s] &&
						T.setRequestHeader('If-None-Match', _.etag[s])),
				...
				function $(t, n, o, l) {
					...
					c ||
						...
						(T.statusText = (n || C) + ''),
						h
							? v.resolveWith(f, [p, C, T])
							: v.rejectWith(f, [T, C, m]),
						T.statusCode(w),
						(w = void 0),
						u &&
		...
		_.each(['get', 'post'], function (e, t) {
			_[t] = function (e, n, i, s) {
				return (
					f(n) && ((s = s || i), (i = n), (n = void 0)),
					_.ajax(
						_.extend(
							{
								url: e,
	...
	_.ajaxSetup({
		...
		_.ajaxPrefilter('json jsonp', function (t, n, i) {
			...
			if (a || 'jsonp' === t.dataTypes[0])
				return (
					...
					i.always(function () {
						void 0 === r ? _(e).removeProp(s) : (e[s] = r),
							t[s] &&
				...
				if (this[0]) {
					...
					if ('fixed' === _.css(i, 'position'))
						...
						e &&
							e !== i &&
							1 === e.nodeType &&
							(((s = _(e).offset()).top += _.css(
								e,
								'borderTopWidth',
								!0
							)),
							(s.left += _.css(e, 'borderLeftWidth', !0)));
					}
					return {
						top: t.top - s.top - _.css(i, 'marginTop', !0),
						left: t.left - s.left - _.css(i, 'marginLeft', !0),
					};
				}
			},
		...
		_.each(['top', 'left'], function (e, t) {
			_.cssHooks[t] = Be(d.pixelPosition, function (e, n) {
				if (n)
					return (
						(n = Ie(e, t)),
					...
					run: function () {
						...
						for (n = 0, i = this._coordinates.length; n < i; n++)
							(e = this._coordinates[n - 1] || 0),
								(t = Math.abs(this._coordinates[n]) + r * s),
			...
			(s.prototype.setup = function () {
				...
				n
					? (e.each(n, function (e) {
					  ...
					  'function' ==
							typeof (s = e.extend({}, this.options, n[i]))
								.stagePadding &&
	...
	(function (e, t, n, i) {
		...
		(s.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
			...
			(s.prototype.thumbnail = function (t, n) {
				...
				'youtube' === n.type
					? ((s = '//img.youtube.com/vi/' + n.id + '/hqdefault.jpg'),
					  u(s))
					: 'vimeo' === n.type
					? e.ajax({
							type: 'GET',
	...
	(function (e, t, n, i) {
		...
		!!s('transition') &&
			((e.support.transition = new String(r('transition'))),
			(e.support.transition.end =
				l.transition.end[e.support.transition])),
			!!s('animation') &&
				((e.support.animation = new String(r('animation'))),
				(e.support.animation.end =
					l.animation.end[e.support.animation])),
			s('transform') &&
				((e.support.transform = new String(r('transform'))),
				(e.support.transform3d = !!s('perspective')));
	})(window.Zepto || window.jQuery, window, document),
	$(window).on('load', function () {
		var e = $('.loader');
		e.find('.loader-inner').fadeOut(), e.delay(300).fadeOut('slow');
	}),
	$(document).ready(function () {
		$('svg').hasClass('search-bg--left') &&
			$('.search-bg__item').each(function (e) {
				var t = $(this);
				setTimeout(function () {
					t.addClass('animate');
				}, 150 * e),
			...
			$('svg').hasClass('search-bg--right') &&
				$('.search-bg__item--right').each(function (e) {
					var t = $(this);
					setTimeout(function () {
						t.addClass('animate');
					}, 150 * e),
		...
		function s() {
			t.css('height', e);
			var i = t.children();
			(e = t.children().height() + n + 'px'),
				t.animate({ height: e }, 300),
				i.animate({ opacity: '1' }, 300),
				t.children().css('position', 'static'),
				setTimeout(function () {
					t.css('height', 'auto');
				}, 500);
		}
		$('#letter-A')
			...
			$('.owl-last-added').owlCarousel({
				...
				responsive: {
					...
					1280: { margin: 20, items: 3, nav: !0, dots: !1 },
				},
			}),
		...
		'' != r &&
			...
			$('svg').hasClass('main-bg__right') &&
				$('.main-bg__item--right').each(function (e) {
					var t = $(this);
					setTimeout(function () {
						t.addClass('animate');
					}, 200 * e),
		...
		var o = $(
			...
			u = $('.types__item,.testimonials');
		$('#control1').click(function () {
			o.addClass('active'), u.not(o).removeClass('active');
		}),
			$('#control2').click(function () {
				a.addClass('active'), u.not(a).removeClass('active');
			}),
			$('#control3').click(function () {
				l.addClass('active'), u.not(l).removeClass('active');
			}),
			$('#control4').click(function () {
				c.addClass('active'), u.not(c).removeClass('active');
			}),
			$('svg').hasClass('seo-bg--left') &&
				$('.seo-bg__item').each(function (e) {
					var t = $(this);
					setTimeout(function () {
						t.addClass('animate');
					}, 150 * e),
			...
			$('svg').hasClass('seo-bg--right') &&
				$('.seo-bg__item--right').each(function (e) {
					var t = $(this);
					setTimeout(function () {
						t.addClass('animate');
					}, 150 * e),
...
function replaceElementTag(e, t) {
	$(e).each(function () {
		var e = $(t, { html: $(this).html() });
	...
	$(document).ready(function () {
		$(
			...
			$('.plagiarism-banner .btn a').click(function () {
				$('.plagiarism-banner').addClass('hidden'),
					...
					gtag('event', 'select_content', {
						promotions: [
							{ id: 'abc123', name: 'Samples Plagiarism Banner' },
						],
					});
			}),
			$('.plagiarism-banner #cliptext').text($('.clip').text()),
			$('.clipboard').click(function () {
				var e = $('#cliptext').get(0),
			...
			$('.promo').click(function (e) {
				...
				var t = $('<input>');
				$('body').append(t),
					t.val($(this).find('span').text()).select(),
					document.execCommand('copy'),
					t.remove(),
					$('.promo').addClass('copy'),
					setTimeout(function () {
		...
		const e =
			...
			n = document.querySelector('.wrapper-form'),
			i = document.querySelector('.g-recaptcha');
		(captchaMessage = $('.form-captcha .error-message')),
			t.addEventListener('submit', async function (n) {
				if (
					(n.preventDefault(),
					0 ==
						(function (t) {
					...
					for (const n of new FormData(t)) e.append(n[0], n[1]);
					fetch('send.php', { method: 'POST', body: e })
						.then((e) => e.json())
						.then((e) => {
							console.log(e),
								e.success
...
var screenHeight = $(window).height(),
	scrollHeight = 4 * screenHeight;
if (
	($(window).scroll(function () {
		if ($(this).scrollTop() >= scrollHeight) {
			if (($('.btn_up').fadeIn(), 'function' == typeof gtag)) {
				var e = !1;
				return function () {
					e || ((e = !0), gtag('event', 'Back to Top Button Viewed'));
				};
			}
		} else $('.btn_up').fadeOut();
	}),
	...
	function serviceTypeHandler() {
		$(this).hasClass('active') ||
			('Other' == $(this).text()
				? ($('.calc-body').stop().fadeOut(0),
				  $('.type-other').stop().fadeIn())
				: 'Other' == $('.service-type.active').text() &&
				  ($('.type-other').stop().fadeOut(0),
				  $('.calc-body').stop().fadeIn()),
			$(this).addClass('active').siblings().removeClass('active'),
			checkPrice());
	}
	function selectHandler() {
		$('.visible-block.active').length &&
			$('.visible-block.active') !== $(this) &&
	...
	function optionHandler() {
		$(this).addClass('active').siblings().removeClass('active'),
			$(this)
				...
				.text($(this).text()),
			checkPrice(),
			$(this).parent().siblings('.visible-block').removeClass('active');
	}
	function checkPrice() {
		let i = $('.pp .option.active').text(),
			s = $('.dl .option.active').data('dl'),
			r = $('.service-type.active').text(),
			o = Math.pow(e[i], 1.2),
			a = ((t[r] * (o - 1 + 1 * n[s])).toFixed(2) / 3).toFixed(2);
		$('.final .price').text('$' + a);
	}
	const e = {
			'High School': 1,
			'College Freshman': 1.15,
			'College Sophomore': 1.25,
			'College Junior': 1.35,
			'College Senior': 1.45,
			"Master's": 1.6,
			PhD: 1.75,
			'Business (Standard)': 1.25,
			'Business (Premium)': 1.5,
		},
		t = { Writing: 15, Editing: 10, Other: 0 },
		n = {
			0: 2.225,
			1: 2.2,
			2: 2.1,
	...
	$('.visible-block').on('click', selectHandler),
		$('.option').on('click', optionHandler),
		$('.service-type').on('click', serviceTypeHandler),
		checkPrice();
}
const btnMobileBack = document.querySelector('#menu-back'),
	btnMobileServices = document.querySelector('#menu-services-mob'),
	menuMob = document.querySelector('.dropdown-menu');
btnMobileBack.addEventListener('click', (e) => {
	e.preventDefault, btnMobileServices.classList.toggle('active');
}),
	btnMobileServices.addEventListener('click', (e) => {
		e.preventDefault;
		if (btnMobileServices.classList.contains('active')) {
			menuMob.style.display = 'grid';
		}
	});
